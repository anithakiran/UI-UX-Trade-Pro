...
interface FeatureBoxProps {
  icon: ReactNode; // ReactNode covers any valid React child (e.g., JSX.Element, string, etc.)
  title: string; // The title should be a string
  description: string; // The description should also be a string
  delay?: number; // Delay is optional and should be a number
}
